 ...
 *
 */
package com.pizzahutstore.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(PizzahutFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(PizzahutFulfilmentProcessConstants.PARENT_PROCESS);
