 ...
 *
 */
package com.pizzahutstore.storefront.controllers.pages;
...
import com.pizzahutstore.storefront.controllers.ControllerConstants;
...
public class AccountPageControllerTest
{
	...
	private final String VIEW_FOR_PAGE = "accountTest.jsp";
	private final String VIEW_PREFIX = "pages/";
	private final String FULL_VIEW_PATH = VIEW_PREFIX + VIEW_FOR_PAGE;
	private final String TITLE_FOR_PAGE = "Account Test Title";
	...
	public void shouldGetEditAddress() throws CMSItemNotFoundException
	{
		...
		Mockito.verify(page).addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
