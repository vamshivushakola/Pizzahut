...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/pizzahutstorefront/electronics/en",
						"https://electronics.local:9002/pizzahutstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/pizzahutstorefront/electronics/en",
						"https://electronics.local:9002/pizzahutstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/pizzahutstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/pizzahutstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/pizzahutstorefront/electronics/en",
						"https://electronics.local:9002/pizzahutstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/pizzahutstorefront",
						"https://electronics.local:9002/pizzahutstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/pizzahutstorefront",
						"https://electronics.local:9002/pizzahutstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/pizzahutstorefront/electronics/en",
						"https://electronics.local:9002/pizzahutstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
