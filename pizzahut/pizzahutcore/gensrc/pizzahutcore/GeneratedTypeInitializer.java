...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			"ApparelProduct",
			"Product",
			com.pizzahutstore.core.jalo.ApparelProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"VariantProduct",
			com.pizzahutstore.core.jalo.ApparelStyleVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"ApparelStyleVariantProduct",
			com.pizzahutstore.core.jalo.ApparelSizeVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			"PizzahutSizeVariantProduct",
			"VariantProduct",
			com.pizzahutstore.core.jalo.PizzahutSizeVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"VariantProduct",
			com.pizzahutstore.core.jalo.ElectronicsColorVariantProduct.class,
			null,
			false,
			null,
			false
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_PizzahutSizeVariantProduct_size();
	...
	public void single_createattr_PizzahutSizeVariantProduct_size() throws JaloBusinessException
	{
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createEnumerationValues(
			...
			single_setAttributeProperties_PizzahutSizeVariantProduct_size();
			...
			single_setAttributeProperties_ElectronicsColorVariantProduct_color();
				...
				setDefaultProperties(
					...
					null
						...
						public void single_setAttributeProperties_PizzahutSizeVariantProduct_size() throws JaloBusinessException
						{
