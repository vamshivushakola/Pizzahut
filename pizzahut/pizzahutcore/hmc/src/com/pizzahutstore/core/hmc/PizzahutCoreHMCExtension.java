 ...
 *
 */
package com.pizzahutstore.core.hmc;
...
/**
 * Provides necessary meta information about the pizzahutcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class PizzahutCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(PizzahutCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.pizzahutstore.core.hmc.locales";
