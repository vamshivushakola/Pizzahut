 ...
 *
 */
package com.pizzahutstore.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("pizzahutcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("pizzahutcockpits.product.externalTaxes"));
