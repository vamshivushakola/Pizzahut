 ...
 *
 */
package com.pizzahutstore.cockpits.setup;
...
import com.pizzahutstore.cockpits.constants.PizzahutCockpitsConstants;
 ...
 */
@SystemSetup(extension = PizzahutCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(PizzahutCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(PizzahutCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						PizzahutCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/pizzahutcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
