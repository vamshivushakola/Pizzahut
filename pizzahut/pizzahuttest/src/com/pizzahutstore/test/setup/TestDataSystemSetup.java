 ...
 *
 */
package com.pizzahutstore.test.setup;
...
import com.pizzahutstore.test.constants.PizzahutTestConstants;
import com.pizzahutstore.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = PizzahutTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/pizzahuttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/pizzahuttest/import/reviews.impex");
			...
			importImpexFile(context, "/pizzahuttest/import/cstickets.impex");
		}
	}
}
